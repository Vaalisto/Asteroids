...
public class Ship extends GameObj {
    ...
    /**
     * Ship-luokan konstruktori. Nämä jätetään muuttujiksi ja aluksen speksejä voidaan muuttaa pelin toteuttavassa luokassa sen sijaan, että kovakoodattaisiin tähän luokkaan.
